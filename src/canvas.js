import { CanvasSpace, Line, Vector, Form, Const } from '../libs/pt.min.js';
// import { CanvasSpace, Line, Vector, Form, Const } from 'ptjs';
...
floatyspace.style.visibility = "visible";
floatyspace.classList.add('fade-in-1dot5s');
setTimeout(()=>{
